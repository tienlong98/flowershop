...
<body>
            ...
            <div class="menu-pc-icon d-flex">
                ...
                <div class="list-icon">
                    <ul>
                        ...
                        <li class="css-user">
                                <a style="color: #544e48" class="fix-hover" href="">{{Auth::user()->name}} <i class="fas fa-angle-down ml-1"></i></a>
                                <div class="list-menu-user">
                                    <div class="mt-2"><a href="{{route('admin.dashboard')}}">Dashboard</a></div>
                                    <div class="mt-2"><a href="{{route('admin.categories')}}">カテゴリー</a></div>
                                    <div class="mt-2"><a href="{{route('admin.product')}}">製品</a></div>
                                    <div class="mt-2"><a href="{{route('admin.coupons')}}">クーポン</a></div>
                                    <div class="mt-2"><a href="{{route('admin.orders')}}">注文</a></div>

                                    <div class="mt-2"><a href="{{route('logout')}}"onclick="event.preventDefault(); document.getElementById('logout-form').submit('');">ログアウト</a></div>
                            ...
                            @else
                            <li class="css-user">
                                <a class="fix-hover" href="">{{Auth::user()->name}}<i class="fas fa-angle-down ml-1"></i></a>
                                    <div class="list-menu-user">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 mt-5 text-center">
                    ...
                    <p class="text-footer">
                        Flowers always make people better, <br>happier, they are sunshine and medicine for the soul.
                    </p>
    ...
    <script src="https://cdn.tiny.cloud/1/1fta24jotxvdro0bnopd4chqacl8d7m3wxaty5qho3g11vtk/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
</body>
