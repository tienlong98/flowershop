                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="ml-2" onclick="confirm('削除しますか？') || event.stopImmediatePropagation()" href="#" wire:click.prevent="deleteCoupon({{$coupon->id}})"><i class="far fa-times-circle text-danger"></i></a>
