                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="ml-2" onclick="confirm('Ban co chac chan Xoa') || event.stopImmediatePropagation()" href="#" wire:click.prevent="deleteCategory({{$category->id}})"><i class="far fa-times-circle text-danger"></i></a>
